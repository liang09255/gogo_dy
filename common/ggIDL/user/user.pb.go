...
type UserFavoriteActionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UserFavoriteActionRequest) Reset() {
	*x = UserFavoriteActionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserFavoriteActionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserFavoriteActionRequest) ProtoMessage() {}

func (x *UserFavoriteActionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_user_user_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserFavoriteActionRequest.ProtoReflect.Descriptor instead.
func (*UserFavoriteActionRequest) Descriptor() ([]byte, []int) {
	return file_user_user_proto_rawDescGZIP(), []int{7}
}

func (x *UserFavoriteActionRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserFavoriteActionRequest) GetToUserId() int64 {
	if x != nil {
		return x.ToUserId
	}
	return 0
...
func (x *UserFavoriteActionRequest) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *UserFavoriteActionRequest) GetAction() int64 {
	if x != nil {
		return x.Action
	}
	return 0
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x22, 0xea, 0x02, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x22, 0x80, 0x01, 0x0a, 0x19, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74,
	0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x1c, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x6f, 0x72,
	0x69, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x32, 0x93, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x08, 0x52, 0x65,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x0c, 0x4d,
	...
	,
}
...
var file_user_user_proto_goTypes = []interface{}{
	...
	(*UserFavoriteActionRequest)(nil),  // 7: user.UserFavoriteActionRequest
	(*UserFavoriteActionResponse)(nil), // 8: user.UserFavoriteActionResponse
}
var file_user_user_proto_depIdxs = []int32{
	...
	7, // 4: user.User.UserFavoriteAction:input_type -> user.UserFavoriteActionRequest
	1, // 5: user.User.Register:output_type -> user.RegisterResponse
	3, // 6: user.User.Login:output_type -> user.LoginResponse
	5, // 7: user.User.MGetUserInfo:output_type -> user.UserInfoResponse
	8, // 8: user.User.UserFavoriteAction:output_type -> user.UserFavoriteActionResponse
...
func file_user_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_user_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserFavoriteActionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
