...
//func (r *relationDal) GetAllFollow(token string, id int64, resp *[]userCtlModel.User) error {
//	var db = global.MysqlDB
//	res := make([]Relation, 1000)
//
//	db.Where("follow_id = ?", id).Find(&res)
//	var tmp userCtlModel.User
//	for k := range res {
//		id := res[k].UserId
//
//		user, err := UserDal.GetUserInfoById(id)
//		if err != nil {
//			return err
//		}
//
...
//func (r *relationDal) GetAllFollower(token string, id int64, resp *[]userCtlModel.User) error {
//	var db = global.MysqlDB
//	res := make([]Relation, 1000)
//
...
//
//// GetAllFriend 获取好友列表
//func (r *relationDal) GetAllFriend(token string, Id int64, resp *[]userCtlModel.User) error {
//	var db = global.MysqlDB
//	res := make([]Relation, 1000)
//
//	db.Where("user_id = ?", Id).Find(&res)
